...
假设先用 3 刀买入一份 Call，后来以 5 刀卖出同一合约：

> 3 刀买入是 Buy to Open
>
> 5 刀卖出是 Sell to Close
>
> 忽略费用后的期权交易利润为 2 刀
...
以标准股票期权的一张 100 Call 为例，如果合约乘数为 100，行权 Call 通常意味着支付 10,000 刀并取得 100 股股票，而不是只支付当初买 Call 的权利金。
...
假设一份 Call 的内在价值为 8 刀，市场上仍能以 9.20 刀卖出：

> 直接行权只实现约 8 刀内在价值
>
> 卖出平仓则可能同时保留 1.20 刀剩余时间价值
...
假设账户持有一张 100 / 105 Bull Call Spread：Long 100 Call，Short 105 Call，合约乘数为 100。临近到期时标的价格为 104.80 刀。

表面上看，两条腿之间还有 0.20 刀距离，但真正需要检查的是：

1. Long 100 Call 是否会进入行权处理，需要准备多少资金？
2. 收盘后价格如果涨过 105 刀，Short Call 是否可能被指派？
