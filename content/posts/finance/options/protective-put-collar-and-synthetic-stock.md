...
如果“行权”和“指派”仍容易混淆，可以先阅读[《开仓、平仓、行权、指派与到期结算》](/posts/finance/options/open-close-exercise-assignment-and-settlement/)：Long Option 的持有人选择是否行使权利，Short Option 的卖方则承担被分配履约义务的可能。
